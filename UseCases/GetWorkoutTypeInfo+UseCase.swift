...
extension UseCase {
    public struct GetWorkoutTypeInfo: GetWorkoutTypeInfoUseCase {
        func call(for workoutType: WorkoutType) -> (name: String, symbol: String) {
            switch workoutType {
            ...
            case .cycling:
                return ("Cycling", "figure.outdoor.bike")
            case .dance:
